...
namespace Momiji
{
    public class SampleRequest : API<SampleRequest>
    {
        ...
        {
            RequestData<SampleResponse> request = new RequestData<SampleResponse>(UnityWebRequest.Get(Path.Combine(hostURL, path)));
        ...
        public static void Post(string sample, System.Action<SampleResponse> onSuccess = null, System.Action<string> onError = null)
        {
            ...
            RequestData<SampleResponse> request = new RequestData<SampleResponse>(UnityWebRequest.Post(hostURL, form));
            request.onComplete = onSuccess;
            Instance.Send<SampleResponse>(request);
        }
    }
