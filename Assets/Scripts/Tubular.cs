...
namespace Study
{
    public class Tubular : ProceduralModelingBase
    {
        ...
        protected CatmullRomCurve curve = new CatmullRomCurve();
        ...
        protected override Mesh Build()
        {
            ...
            curve.Points = targetPoints.Select(_ => _.position).ToList();
            ...
            // 閉じた筒型を生成する場合は曲線の始点に最後の頂点を配置
            GenerateSegment(curve, frames, vertices, normals, tangents, tubularSegments);
